...
write.table(hubs.hs, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_5hubs.txt"), quote =F,  col.names = F, row.names = T)
write.table(hubs.cn, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_5closeness.txt"), quote =F,  col.names = F, row.names = T)
write.table(hubs.bn, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_5between.txt"), quote =F,  col.names = F, row.names = T)
write.table(hubs.pr, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_5pageRank.txt"), quote =F,  col.names = F, row.names = T)
...
#print(modularity(sparcc.net, membership(sparcc.wt)))
#print(member)
#max(member) -> maxClust
...
write.table(zeroDF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_zero.txt"), quote =F,  col.names = F, row.names = F)
write.table(one5DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_one5.txt"), quote =F,  col.names = F, row.names = F)
write.table(six10DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_six10.txt"), quote =F,  col.names = F, row.names = F)
write.table(eleven15DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_eleven15.txt"), quote =F,  col.names = F, row.names = F)
write.table(sixteen20DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_sixteen20.txt"), quote =F,  col.names = F, row.names = F)
write.table(twentyone25DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_twentyone25.txt"), quote =F,  col.names = F, row.names = F)
write.table(twentysix30DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_twentysix30.txt"), quote =F,  col.names = F, row.names = F)
write.table(thirtyone35DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_thirtyone35.txt"), quote =F,  col.names = F, row.names = F)
write.table(thirtysix40DF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_thirtysix40.txt"), quote =F,  col.names = F, row.names = F)
write.table(fortyAboveDF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_fortyAbove.txt"), quote =F,  col.names = F, row.names = F)

write.table(connectDF, file = paste0("/Users/dave/Desktop/microbiom_R_network/connections_", outName, "_rawConnnects.txt"), quote =F,  col.names = F, row.names = F)
...
write.table(cluster1, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_cluster1.txt"), quote =F,  col.names = F, row.names = T)
write.table(cluster2, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_cluster2.txt"), quote =F,  col.names = F, row.names = T)
write.table(cluster3, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_cluster3.txt"), quote =F,  col.names = F, row.names = T)
write.table(cluster4, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_cluster4.txt"), quote =F,  col.names = F, row.names = T)
write.table(cluster5, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_cluster5.txt"), quote =F,  col.names = F, row.names = T)
write.table(cluster6, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_cluster6.txt"), quote =F,  col.names = F, row.names = T)
write.table(cluster7, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_cluster7.txt"), quote =F,  col.names = F, row.names = T)
...
plot.net <- function(net, scores, outfile, title) {
  ...
  legend("bottom", legend = labels, xpd = TRUE, ncol = 3, cex = 1.2)
  dev.off()
}

plot.net(sparcc.net, sparcc.net.hs, outfile = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_sparcc_uncolored"), title = outName)

sparcc.AP <- articulation.points(sparcc.net)
as_ids(sparcc.AP) -> AP_ids
write.table(AP_ids, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_AP.txt"), quote =F,  col.names = F, row.names = T)
modularity(sparcc.net, membership(sparcc.wt)) -> mod
write.table(mod, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_modularity.txt"), quote =F,  col.names = F, row.names = T)


outName_degree.dist <- degree_distribution(sparcc.net, mode = "all", cumulative = F)
as.data.frame(outName_degree.dist) -> outDF
write.table(outDF, file = paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_sparcc_degree.txt"), quote =F,  col.names = F, row.names = T)

colorforPlot <- c("cornsilk2", "cornflowerblue","coral","cadetblue1", "chocolate1", "burlywood", "brown3","blueviolet", "grey88", "firebrick1", "lightpink", "lightgoldenrod2", "mediumorchid1", "khaki3", "indianred", "hotpink", "grey54")
...
plot.net.cls <- function(net, scores, cls, AP, outfile, title) {
  ...
  colors <- sample(colorforPlot, length(cls))
  ...
  # Main plot function.
  plot(net, vertex.size = (scores*12) + 1, vertex.label.cex=1.5,
...
plot.net.cls(sparcc.net, sparcc.net.hs, sparcc.wt, sparcc.AP,
             outfile =  paste0("/Users/dave/Desktop/microbiom_R_network/", outName, "_sparcc_colored"), title = outName)
